    ...
    return new class extends Migration
    {
        public function up(): void
        {
            Schema::create('votes', function (Blueprint $table) {
                ...
                $table->foreignId('teacher_id')->constrained('teachers')->onDelete('cascade'); // Qui a voté
                ...
                $table->timestamps();
                $table->unique(['commission_session_id', 'report_id', 'teacher_id', 'vote_round'], 'unique_vote_per_round'); // Un enseignant ne vote qu'une fois par rapport par tour
            });
        }
