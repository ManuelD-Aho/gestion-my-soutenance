        ...
        return $table
            ...
            ->actions([
                ...
                Action::make('return_for_correction')
                    ...
                    ->color('warning')
                    ->visible(fn (Report $record): bool => in_array($record->status, [ReportStatusEnum::SUBMITTED, ReportStatusEnum::IN_CONFORMITY_CHECK, ReportStatusEnum::IN_COMMISSION_REVIEW], true))
                    ->form([
                ...
                Action::make('check_conformity')
                    ...
                    ->color('primary')
                    ->visible(fn (Report $record): bool => in_array($record->status, [ReportStatusEnum::SUBMITTED, ReportStatusEnum::IN_CONFORMITY_CHECK], true))
