<?php
    ...
    use App\Services\UserManagementService; // Assurez-vous que ce service existe
    ...
    class MyProfile extends Page
    {
        ...
        protected function getFormSchema(): array
        {
            $user = Auth::user();
            $profileType = null;
            if ($user->student) $profileType = 'student';
            elseif ($user->teacher) $profileType = 'teacher';
            elseif ($user->administrativeStaff) $profileType = 'administrative_staff';
