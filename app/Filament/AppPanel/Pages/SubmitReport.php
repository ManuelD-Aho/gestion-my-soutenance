<?php
    ...
    use App\Http\Middleware\EnsureStudentIsEligible; // Assurez-vous que ce middleware est bien défini
    ...
    class SubmitReport extends Page
    {
        ...
        public function save(): void
        {
            ...
            $response = $middleware->handle($request, function ($req) { return null; });
            if ($response) {
