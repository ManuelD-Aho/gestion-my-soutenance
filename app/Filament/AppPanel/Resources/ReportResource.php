            ...
            return $table
                ...
                ->actions([
                    ...
                    Action::make('check_conformity')
                        ...
                        ->form(function (Report $record, ConformityCheckService $conformityCheckService) use ($user) {
                    ...
                    Action::make('download_pdf')
                        ...
                        ->action(function (Report $record, PdfGenerationService $pdfGenerationService) use ($user) {
                            try {
